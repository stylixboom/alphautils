...
OBJ_DEBUG = $(OBJDIR_DEBUG)/alphautils.o $(OBJDIR_DEBUG)/hdf5_io.o $(OBJDIR_DEBUG)/imtools.o $(OBJDIR_DEBUG)/lapwrap.o $(OBJDIR_DEBUG)/linear_tree.o $(OBJDIR_DEBUG)/report.o $(OBJDIR_DEBUG)/tsp.o

OBJ_RELEASE = $(OBJDIR_RELEASE)/alphautils.o $(OBJDIR_RELEASE)/hdf5_io.o $(OBJDIR_RELEASE)/imtools.o $(OBJDIR_RELEASE)/lapwrap.o $(OBJDIR_RELEASE)/linear_tree.o $(OBJDIR_RELEASE)/report.o $(OBJDIR_RELEASE)/tsp.o
